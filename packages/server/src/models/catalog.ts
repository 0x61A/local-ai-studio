...
function hfUrl(repo: string, filename: string): string {
  ...
  return `https://huggingface.co/${repo}/resolve/main/${encoded}?download=true`;
}
...
export const CATALOG_MODELS: CatalogModelItem[] = [
  // -- Popüler & Çok Amaçlı ----------------------------------------------------
  {
    ...
    downloadUrl: hfUrl("bartowski/Qwen2.5-7B-Instruct-GGUF", "Qwen2.5-7B-Instruct-Q4_K_M.gguf"),
    minRamGb: 6,
  ...
  },
  {
    ...
    sizeBytes: 4_920_000_000,
    downloadUrl: hfUrl("bartowski/Meta-Llama-3.1-8B-Instruct-GGUF", "Meta-Llama-3.1-8B-Instruct-Q4_K_M.gguf"),
    minRamGb: 6.5,
  ...
  },
  {
    ...
    downloadUrl: hfUrl("bartowski/gemma-2-9b-it-GGUF", "gemma-2-9b-it-Q4_K_M.gguf"),
    minRamGb: 7.5,
  ...
  },
  {
    ...
    downloadUrl: hfUrl("bartowski/Mistral-7B-Instruct-v0.3-GGUF", "Mistral-7B-Instruct-v0.3-Q4_K_M.gguf"),
    minRamGb: 6,
  ...
  },
  {
    ...
    parameters: "8.0B",
    contextLength: 131072,
    recommendedFile: "Hermes-3-Llama-3.1-8B-Q4_K_M.gguf",
    sizeBytes: 4_920_000_000,
    downloadUrl: hfUrl("bartowski/Hermes-3-Llama-3.1-8B-GGUF", "Hermes-3-Llama-3.1-8B-Q4_K_M.gguf"),
    minRamGb: 6.5,
  ...
  // -- Akıl Yürütme & Düşünme (Reasoning / R1) --------------------------------
  {
    ...
    parameters: "7.6B",
    contextLength: 131072,
    recommendedFile: "DeepSeek-R1-Distill-Qwen-7B-Q4_K_M.gguf",
    sizeBytes: 4_680_000_000,
    downloadUrl: hfUrl("bartowski/DeepSeek-R1-Distill-Qwen-7B-GGUF", "DeepSeek-R1-Distill-Qwen-7B-Q4_K_M.gguf"),
    minRamGb: 6.5,
  ...
  },
  {
    ...
    downloadUrl: hfUrl("bartowski/DeepSeek-R1-Distill-Qwen-14B-GGUF", "DeepSeek-R1-Distill-Qwen-14B-Q4_K_M.gguf"),
    minRamGb: 11.5,
  ...
  },
  {
    ...
    parameters: "8.0B",
    contextLength: 131072,
    recommendedFile: "DeepSeek-R1-Distill-Llama-8B-Q4_K_M.gguf",
    sizeBytes: 4_920_000_000,
    downloadUrl: hfUrl("bartowski/DeepSeek-R1-Distill-Llama-8B-GGUF", "DeepSeek-R1-Distill-Llama-8B-Q4_K_M.gguf"),
    minRamGb: 6.5,
  ...
  },
  {
    ...
    parameters: "1.5B",
    contextLength: 131072,
    recommendedFile: "DeepSeek-R1-Distill-Qwen-1.5B-Q4_K_M.gguf",
    sizeBytes: 1_120_000_000,
    downloadUrl: hfUrl("bartowski/DeepSeek-R1-Distill-Qwen-1.5B-GGUF", "DeepSeek-R1-Distill-Qwen-1.5B-Q4_K_M.gguf"),
    minRamGb: 2,
  ...
  // -- Kodlama & Yazılım (Coding & Developer) ---------------------------------
  {
    ...
    parameters: "7.6B",
    contextLength: 131072,
    recommendedFile: "qwen2.5-coder-7b-instruct-q4_k_m.gguf",
    sizeBytes: 4_680_000_000,
    downloadUrl: hfUrl("Qwen/Qwen2.5-Coder-7B-Instruct-GGUF", "qwen2.5-coder-7b-instruct-q4_k_m.gguf"),
    minRamGb: 6.5,
  ...
  },
  {
    ...
    parameters: "14.8B",
    contextLength: 131072,
    recommendedFile: "qwen2.5-coder-14b-instruct-q4_k_m.gguf",
    sizeBytes: 8_990_000_000,
    downloadUrl: hfUrl("Qwen/Qwen2.5-Coder-14B-Instruct-GGUF", "qwen2.5-coder-14b-instruct-q4_k_m.gguf"),
    minRamGb: 11.5,
  ...
  },
  {
    ...
    parameters: "1.5B",
    contextLength: 32768,
    recommendedFile: "qwen2.5-coder-1.5b-instruct-q4_k_m.gguf",
    sizeBytes: 1_040_000_000,
    downloadUrl: hfUrl("Qwen/Qwen2.5-Coder-1.5B-Instruct-GGUF", "qwen2.5-coder-1.5b-instruct-q4_k_m.gguf"),
    minRamGb: 1.8,
  ...
  },
  {
    ...
    parameters: "6.7B",
    contextLength: 16384,
    recommendedFile: "deepseek-coder-6.7b-instruct.Q4_K_M.gguf",
    sizeBytes: 4_080_000_000,
    downloadUrl: hfUrl("TheBloke/deepseek-coder-6.7B-instruct-GGUF", "deepseek-coder-6.7b-instruct.Q4_K_M.gguf"),
    minRamGb: 5.5,
  ...
  },
  {
    ...
    parameters: "22.2B",
    contextLength: 32768,
    recommendedFile: "Codestral-22B-v0.1-Q4_K_M.gguf",
    sizeBytes: 13_500_000_000,
    downloadUrl: hfUrl("bartowski/Codestral-22B-v0.1-GGUF", "Codestral-22B-v0.1-Q4_K_M.gguf"),
    minRamGb: 16.5,
  ...
  // -- Hafif & Hızlı (Lightweight / Laptop) -----------------------------------
  {
    ...
    downloadUrl: hfUrl("bartowski/Llama-3.2-3B-Instruct-GGUF", "Llama-3.2-3B-Instruct-Q4_K_M.gguf"),
    minRamGb: 3.0,
  ...
  },
  {
    ...
    downloadUrl: hfUrl("bartowski/Llama-3.2-1B-Instruct-GGUF", "Llama-3.2-1B-Instruct-Q4_K_M.gguf"),
    minRamGb: 1.5,
  ...
  },
  {
    ...
    sizeBytes: 2_040_000_000,
    downloadUrl: hfUrl("Qwen/Qwen2.5-3B-Instruct-GGUF", "qwen2.5-3b-instruct-q4_k_m.gguf"),
    minRamGb: 3.0,
  ...
  },
  {
    ...
    parameters: "1.5B",
    contextLength: 32768,
    recommendedFile: "qwen2.5-1.5b-instruct-q4_k_m.gguf",
    sizeBytes: 1_040_000_000,
    downloadUrl: hfUrl("Qwen/Qwen2.5-1.5B-Instruct-GGUF", "qwen2.5-1.5b-instruct-q4_k_m.gguf"),
    minRamGb: 1.8,
  ...
  },
  {
    ...
    downloadUrl: hfUrl("bartowski/Phi-3.5-mini-instruct-GGUF", "Phi-3.5-mini-instruct-Q4_K_M.gguf"),
    minRamGb: 3.5,
  ...
  },
  {
    ...
    downloadUrl: hfUrl("bartowski/gemma-2-2b-it-GGUF", "gemma-2-2b-it-Q4_K_M.gguf"),
    minRamGb: 2.5,
  ...
  },
  {
    ...
    parameters: "1.7B",
    contextLength: 8192,
    recommendedFile: "SmolLM2-1.7B-Instruct-Q4_K_M.gguf",
    sizeBytes: 1_080_000_000,
    downloadUrl: hfUrl("bartowski/SmolLM2-1.7B-Instruct-GGUF", "SmolLM2-1.7B-Instruct-Q4_K_M.gguf"),
    minRamGb: 1.8,
  ...
  // -- Büyük & İleri Düzey (Large & High Power) ------------------------------
  {
    ...
    parameters: "14.8B",
    contextLength: 131072,
    recommendedFile: "Qwen2.5-14B-Instruct-Q4_K_M.gguf",
    sizeBytes: 8_990_000_000,
    downloadUrl: hfUrl("bartowski/Qwen2.5-14B-Instruct-GGUF", "Qwen2.5-14B-Instruct-Q4_K_M.gguf"),
    minRamGb: 11.5,
  ...
  },
  {
    ...
    parameters: "32.8B",
    contextLength: 131072,
    recommendedFile: "Qwen2.5-32B-Instruct-Q4_K_M.gguf",
    sizeBytes: 19_800_000_000,
    downloadUrl: hfUrl("bartowski/Qwen2.5-32B-Instruct-GGUF", "Qwen2.5-32B-Instruct-Q4_K_M.gguf"),
    minRamGb: 24.0,
  ...
  },
  {
    ...
    sizeBytes: 9_130_000_000,
    downloadUrl: hfUrl("bartowski/phi-4-GGUF", "phi-4-Q4_K_M.gguf"),
    minRamGb: 11.5,
  ...
  },
  {
    ...
    parameters: "24.0B",
    contextLength: 32768,
    recommendedFile: "Mistral-Small-24B-Instruct-2501-Q4_K_M.gguf",
    sizeBytes: 14_500_000_000,
    downloadUrl: hfUrl("bartowski/Mistral-Small-24B-Instruct-2501-GGUF", "Mistral-Small-24B-Instruct-2501-Q4_K_M.gguf"),
    minRamGb: 18.0,
  ...
  },
  {
    ...
    downloadUrl: hfUrl("bartowski/Llama-3.3-70B-Instruct-GGUF", "Llama-3.3-70B-Instruct-Q4_K_M.gguf"),
    minRamGb: 48.0,
  ...
  // -- Görsel & Çok Modlu (Multimodal / Vision) ------------------------------
  {
    ...
    parameters: "7.6B",
    contextLength: 32768,
    recommendedFile: "Qwen2-VL-7B-Instruct-Q4_K_M.gguf",
    sizeBytes: 4_680_000_000,
    downloadUrl: hfUrl("bartowski/Qwen2-VL-7B-Instruct-GGUF", "Qwen2-VL-7B-Instruct-Q4_K_M.gguf"),
    minRamGb: 6.5,
  ...
  },
  {
    ...
    parameters: "11.0B",
    contextLength: 131072,
    recommendedFile: "Llama-3.2-11B-Vision-Instruct.Q4_K_M.gguf",
    sizeBytes: 5_963_057_216,
    downloadUrl: hfUrl("leafspark/Llama-3.2-11B-Vision-Instruct-GGUF", "Llama-3.2-11B-Vision-Instruct.Q4_K_M.gguf"),
    minRamGb: 9.5,
  ...
  },
  {
    ...
    parameters: "8.0B",
    contextLength: 32768,
    recommendedFile: "MiniCPM-V-2_6-Q4_K_M.gguf",
    sizeBytes: 4_681_089_792,
    downloadUrl: hfUrl("bartowski/MiniCPM-V-2_6-gguf", "MiniCPM-V-2_6-Q4_K_M.gguf"),
    minRamGb: 7.0,
  ...
  // -- Gömme & Bilgi Tabanı (Embeddings & RAG) -------------------------------
  {
    ...
    parameters: "137M",
    contextLength: 8192,
    recommendedFile: "nomic-embed-text-v1.5.Q8_0.gguf",
    sizeBytes: 150_000_000,
    downloadUrl: hfUrl("nomic-ai/nomic-embed-text-v1.5-GGUF", "nomic-embed-text-v1.5.Q8_0.gguf"),
    minRamGb: 0.5,
  ...
  },
  {
    ...
    parameters: "567M",
    contextLength: 8192,
    recommendedFile: "bge-m3-Q8_0.gguf",
    sizeBytes: 600_000_000,
    downloadUrl: hfUrl("gpustack/bge-m3-GGUF", "bge-m3-Q8_0.gguf"),
    minRamGb: 1.0,
  ...
  },
  {
    ...
    parameters: "560M",
    contextLength: 512,
    recommendedFile: "multilingual-e5-large-q8_0.gguf",
    sizeBytes: 600_000_000,
    downloadUrl: hfUrl("cstr/multilingual-e5-large-GGUF", "multilingual-e5-large-q8_0.gguf"),
    minRamGb: 1.0,
  ...
  },
  {
    ...
    parameters: "335M",
    contextLength: 512,
    recommendedFile: "bge-large-en-v1.5-q8_0.gguf",
    sizeBytes: 360_000_000,
    downloadUrl: hfUrl("CompendiumLabs/bge-large-en-v1.5-gguf", "bge-large-en-v1.5-q8_0.gguf"),
    minRamGb: 0.8,
...
export function getCatalog(lang: "tr" | "en" = "tr", freeBudgetMb = 8192): CatalogModelResponse[] {
  return CATALOG_MODELS.map((item) => {
    ...
    if (lang === "tr") {
      fitsReason = fits
        ? `Sisteminizde akıcı çalışır (~${(estimatedMb / 1024).toFixed(1)} GB bellek)`
        : `Yüksek bellek gerektirir (~${(estimatedMb / 1024).toFixed(1)} GB bellek, boşta ~${(freeBudgetMb / 1024).toFixed(1)} GB)`;
    } else {
      fitsReason = fits
        ? `Runs smoothly on your system (~${(estimatedMb / 1024).toFixed(1)} GB RAM)`
        : `Requires high memory (~${(estimatedMb / 1024).toFixed(1)} GB RAM, ~${(freeBudgetMb / 1024).toFixed(1)} GB free)`;
    }
